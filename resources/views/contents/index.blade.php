        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Content</span>
                </a>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td>
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdownId" type="button"><svg
                        ...
                        <div id="dropdownId"
                            ...
                            <ul class=" z-40 py-2 text-sm text-gray-700 dark:text-gray-200"
